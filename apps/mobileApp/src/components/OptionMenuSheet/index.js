    ...
    <RBSheet
      ...
      customStyles={{
        container: {
          ...
          maxHeight: screenHeight * 0.9, // 80% of screen height
        },
        wrapper: {
      ...
      <View style={styles.bottomSheetView}>
        {title && (
          <View style={{backgroundColor: '#FFF4EC'}}>
            <Text
              style={{
                color: '#aaa',
                textAlign: 'center',
...
const styles = StyleSheet.create({
  ...
  bottomSheetView: {
    flex: 1, // Ensures the content fills available space
  },
});
